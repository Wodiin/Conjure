...
class TestCalculateHP(unittest.TestCase):
    ...
    def test_melee_positive_con(self):
        ...
        self.assertEqual(result["hp"], 161)
        self.assertEqual(result["dice_string"], "19d10 + 57")

    def test_full_caster_positive_con(self):
        """Full Caster (d6) at CR 5 with +1 CON mod."""
        # 19 dice, avg 3.5, con +1: 19 * 3.5 + 19 * 1 = 66.5 + 19 = 85
        result = calculate_hp("5", "Full Caster", 1)
        self.assertEqual(result["hp"], 85)
        self.assertEqual(result["dice_string"], "19d6 + 19")

    def test_ranged_positive_con(self):
        """Ranged (d8) at CR 5 with +2 CON mod."""
        # 19 dice, avg 4.5, con +2: 19 * 4.5 + 19 * 2 = 85.5 + 38 = 123
        result = calculate_hp("5", "Ranged", 2)
        self.assertEqual(result["hp"], 123)
        self.assertEqual(result["dice_string"], "19d8 + 38")
    ...
    def test_negative_con_dice_string(self):
        ...
        self.assertEqual(result["hp"], 47)
        self.assertEqual(result["dice_string"], "19d6 - 19")

    def test_zero_con_dice_string(self):
        """Zero CON mod should omit the modifier from the dice string."""
        result = calculate_hp("5", "Melee", 0)
        # 19 dice, avg 5.5: 19 * 5.5 = 104
        self.assertEqual(result["hp"], 104)
        self.assertEqual(result["dice_string"], "19d10")

    # --- Return type tests ---

    def test_returns_dict(self):
        """Should return a dict with 'hp' (int) and 'dice_string' (str) keys."""
        result = calculate_hp("5", "Melee", 3)
        self.assertIsInstance(result, dict)
        self.assertEqual(set(result.keys()), {"hp", "dice_string"})
        self.assertIsInstance(result["hp"], int)
        self.assertIsInstance(result["dice_string"], str)
    ...
    def test_cr_30_high_con(self):
        ...
        result = calculate_hp("30", "Melee", 7)
        self.assertEqual(result["hp"], 725)
        self.assertEqual(result["dice_string"], "58d10 + 406")
    ...
    def test_melee_more_hp_than_caster_same_cr(self):
        ...
        melee = calculate_hp("10", "Melee", 2)
        caster = calculate_hp("10", "Full Caster", 2)
        self.assertGreater(melee["hp"], caster["hp"])

    def test_higher_con_more_hp(self):
        """Higher CON mod should produce more HP for the same CR and category."""
        low = calculate_hp("5", "Melee", 1)
        high = calculate_hp("5", "Melee", 4)
        self.assertGreater(high["hp"], low["hp"])
...
class TestGetActionDataRaceOnly(unittest.TestCase):
    ...
    def test_firbolg_bonus_action(self):
        ...
        self.assertIn("bonus_actions", result)
        self.assertIn("Hidden Step", result["bonus_actions"])
...
class TestGetActionDataCombatKitOnly(unittest.TestCase):
    ...
    def test_hexblade_bonus_actions(self):
        ...
        self.assertIn("bonus_actions", result)
        self.assertIn("Hexblade's Curse", result["bonus_actions"])
        self.assertIn("Shadow Step", result["bonus_actions"])
...
class TestGetActionDataMagicKitOnly(unittest.TestCase):
    ...
    def test_conjuration_bonus_action(self):
        ...
        self.assertIn("bonus_actions", result)
        self.assertIn("Benign Transposition", result["bonus_actions"])
    ...
    def test_nature_bonus_action(self):
        ...
        self.assertIn("bonus_actions", result)
        self.assertIn("Wild Shape", result["bonus_actions"])
...
class TestGetActionDataFullCombo(unittest.TestCase):
    ...
    def test_bonus_actions_from_race(self):
        ...
        self.assertIn("bonus_actions", self.result)
        self.assertIn("Hidden Step", self.result["bonus_actions"])
        self.assertEqual(len(self.result["bonus_actions"]), 1)
...
class TestGenerateActionDataSpells(unittest.TestCase):
    ...
    def test_highest_mental_stat_selected(self):
        ...
        actions = {"spells": {"Fire Bolt": {"level": 0, "casting_amount": "at will"}}}
        result = generate_action_data("5", modifiers, actions)
        self.assertEqual(result["spells"]["spellcasting_stat"], "INT")
    ...
    def test_wis_selected_when_highest(self):
        ...
        actions = {"spells": {"Fire Bolt": {"level": 0, "casting_amount": "at will"}}}
        result = generate_action_data("5", modifiers, actions)
        self.assertEqual(result["spells"]["spellcasting_stat"], "WIS")
    ...
    def test_use_primary_for_casting(self):
        ...
        self.assertEqual(result["spells"]["spellcasting_stat"], "STR")
    ...
    def test_spell_save_dc(self):
        ...
        actions = {"spells": {"Fire Bolt": {"level": 0, "casting_amount": "at will"}}}
        result = generate_action_data("5", modifiers, actions)
        self.assertEqual(result["spells"]["spell_save_dc"], 15)
    ...
    def test_spell_attack_bonus(self):
        ...
        actions = {"spells": {"Fire Bolt": {"level": 0, "casting_amount": "at will"}}}
        result = generate_action_data("5", modifiers, actions)
        self.assertEqual(result["spells"]["spell_attack_bonus"], 7)
    ...
    def test_spell_save_dc_with_primary_override(self):
        ...
        actions = {"spells": {"Fire Bolt": {"level": 0, "casting_amount": "at will"}}}
        result = generate_action_data("5", modifiers, actions, use_primary_for_casting=True, primary="STR")
        self.assertEqual(result["spells"]["spell_save_dc"], 16)
    ...
    def test_spell_budget_from_cr(self):
        ...
        self.assertEqual(result_cr5["spells"]["spell_budget"], 6)
        self.assertEqual(result_cr13["spells"]["spell_budget"], 10)
    ...
    def test_spells_passed_through(self):
        ...
        result = generate_action_data("5", modifiers, actions)
        self.assertEqual(result["spells"]["spells_list"], spells)
...
class TestGenerateActionDataPassthrough(unittest.TestCase):
    ...
    def test_trait_budget_present_when_traits_exist(self):
        ...
        actions = {"traits": {"Brave": "advantage on saves vs frightened"}}
        result = generate_action_data("5", modifiers, actions)
        self.assertIn("trait_budget", result)
        self.assertEqual(result["trait_budget"], 5)
    ...
    def test_no_trait_budget_without_any_sections(self):
        ...
        actions = {"weapons": ["Longsword"]}
        result = generate_action_data("5", modifiers, actions)
        self.assertNotIn("trait_budget", result)
    ...
    def test_bonus_actions_passed_through(self):
        ...
        actions = {"bonus_actions": bonus_actions}
        result = generate_action_data("5", modifiers, actions)
        self.assertEqual(result["bonus_actions"], bonus_actions)
    ...
    def test_no_bonus_actions_key_when_absent(self):
        ...
        actions = {"weapons": ["Longsword"]}
        result = generate_action_data("5", modifiers, actions)
        self.assertNotIn("bonus_actions", result)
    ...
    def test_trait_budget_scales_with_cr(self):
        ...
        result_cr13 = generate_action_data("13", modifiers, actions)
        self.assertEqual(result_cr0["trait_budget"], 1)
        self.assertEqual(result_cr9["trait_budget"], 8)
        self.assertEqual(result_cr13["trait_budget"], 999)
